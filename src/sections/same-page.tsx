    ...
    <section ref={targetRef}>
      <div className="relative h-[800vh]">
        <div className="sticky top-1/2 flex origin-center -translate-y-1/2 justify-center">
          ...
          >
            ...
            <motion.img
              ...
              className="absolute left-[13%] top-1/2 h-[1.5vw] w-[1.5vw] translate-y-1/2 rounded-full border border-[#f0f]  object-cover will-change-transform"
              src="/images/frammer-logo.png"
            />
            <motion.span
          ...
          >
            ...
            <br />
            Explore a new features and animations in frammer motion
          </motion.p>
        </div>
        <motion.p
          style={stylesWithCssVar({
        ...
        >
          Not only Frammer,
          <br />
          <span className="text-primary">also used TailwindCss.</span>
        </motion.p>
        <motion.p
          style={stylesWithCssVar({
